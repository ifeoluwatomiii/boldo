	...
	return (
		<div className="mt-[206px] flex justify-center items-center gap-[150px] flex-col xl:flex-row px-[20px]">
			...
			<div className="flex flex-col gap-[24px]">
				...
				<div className="px-[20px] xl:px-0">
					<div className="bg-[#0A2640] xl:w-[500px] xl:h-[58px] rounded py-4 xl:px-4 transition transform hover:hover:scale-110 duration-500 ease-in-out mt-2 px-2">
						<img className="absolute" src={star} alt="feather logo" />
						<p className="text-white relative left-[50px] leading-[28px] text-[16px]">
							We connect our customers with the best.
						</p>
					</div>
					<div className="xl:w-[500px] xl:h-[58px] shadow-md shadow-slate-200 rounded py-4 xl:px-4 transition transform hover:hover:scale-110 duration-500 ease-in-out mt-2 px-2">
